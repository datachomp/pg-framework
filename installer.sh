...
sudo ln -nfs /home/rob/pg-framework/configs/pg_hba.conf /etc/postgresql/9.3/main/pg_hba.conf
sudo ln -nfs /home/rob/pg-framework/configs/postgresql.conf /etc/postgresql/9.3/main/postgresql.conf
sudo ln -nfs /home/rob/pg-framework/configs/redis.conf /etc/redis/redis.conf
